...
\begin{itemize}
    \item \hi{Nhân viên bãi xe (Attendant):} thao tác trên UI, hỗ trợ phát vé, thu phí, xác minh mất vé, đăng ký/gia hạn vé tháng.
    \item \hi{Quản trị viên (Admin):} quản lý cấu hình bảng giá, quản lý hạ tầng bãi xe, tài khoản, xem báo cáo, hủy vé tháng.
